...
- restoring the frontend console/checker workflow next

## Recovered Scope

This initial recovery includes:

- core project documentation
- backend settings and schema contracts
- project lifecycle service contracts
- a minimal FastAPI app shell
- a minimal frontend console scaffold
...
- frontend/operator console direction
