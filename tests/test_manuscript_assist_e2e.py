...
from app.services.manuscript_assist import ManuscriptAssistService


def test_manuscript_assist_apply_flow_e2e(tmp_path) -> None:
    ...
    service = ManuscriptAssistService(repository=repo, drafting_service=drafting, job_manager=jobs)
    ...
    assert applied.manuscript.content == "Hi world"
