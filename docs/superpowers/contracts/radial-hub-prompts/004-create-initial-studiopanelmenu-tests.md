# Executor Prompt: RH-T004 - Create initial StudioPanelMenu tests
...
- Responsible file: `frontend/src/components/studio/StudioPanelMenu.test.tsx`
- Serial dependencies: RH-T001
- Same-file serial group: none

## Objective
Add tests for panel menu opening and panel-option rendering.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioPanelMenu.test.tsx`.
...
## Expected Result
- The test file exists and targets the Phase 1 menu API.
