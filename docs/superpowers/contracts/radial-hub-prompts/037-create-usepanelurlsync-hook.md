# Executor Prompt: RH-T037 - Create usePanelUrlSync hook
...
- Responsible file: `frontend/src/hooks/usePanelUrlSync.ts`
- Serial dependencies: RH-T036
- Same-file serial group: none

## Objective
Create the two-way panel-to-URL hook with validated tab keys and nullable projectId handling.
...
## Instructions
1. Modify only `frontend/src/hooks/usePanelUrlSync.ts`.
