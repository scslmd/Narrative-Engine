# Executor Prompt: RH-T028 - Create StudioFloatingWindow implementation
...
- Responsible file: `frontend/src/components/studio/StudioFloatingWindow.tsx`
- Serial dependencies: RH-T003
- Same-file serial group: none

## Objective
Create the portal-based floating window wrapper mounted to document.body with drag, resize, reattach, and close support.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioFloatingWindow.tsx`.
