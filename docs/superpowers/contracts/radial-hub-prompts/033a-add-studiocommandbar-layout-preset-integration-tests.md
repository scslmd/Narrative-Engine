# Executor Prompt: RH-T033A - Add StudioCommandBar layout preset integration tests
...
- Responsible file: `frontend/src/components/studio/StudioCommandBar.layoutPreset.test.tsx`
- Serial dependencies: RH-T033
- Same-file serial group: none

## Objective
Add focused tests proving the command bar mounts the layout preset control next to the panel menu without removing existing controls.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioCommandBar.layoutPreset.test.tsx`.
...
## Expected Result
- Focused StudioCommandBar layout preset integration tests pass.
