# Executor Prompt: RH-T043 - Update StudioProjectRail bottom links to studio URLs
...
## Objective
Replace legacy plan/canon links with direct studio query-param links.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioProjectRail.tsx`.
