# Executor Prompt: RH-T049 - Create integrated radial-hub accessibility tests
...
- Responsible file: `frontend/src/components/studio/accessibility.test.tsx`
- Serial dependencies: RH-T045, RH-T046, RH-T047, RH-T048
- Same-file serial group: none

## Objective
Create integration tests covering panel ARIA roles, panel menu semantics, and radial-hub accessibility affordances.
...
## Instructions
1. Modify only `frontend/src/components/studio/accessibility.test.tsx`.
...
- `cd frontend; cmd /c npm.cmd run test -- accessibility.test.tsx`

## Expected Result
- Focused accessibility tests pass.
