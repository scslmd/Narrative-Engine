# Executor Prompt: RH-T013 - Migrate StudioDraftsPanel from useParams to projectId prop
...
- Responsible file: `frontend/src/components/studio/StudioDraftsPanel.tsx`
- Serial dependencies: RH-T012
- Same-file serial group: none

## Objective
Replace route-param usage with an explicit projectId prop and keep the existing draft-assist behavior.
...
- `StudioDraftsPanelProps`
- `projectId`
- `useAssistController`

## Task Guardrails
- frontend/src/hooks/useWritingView.ts
- frontend/src/domains/writing/useAssistController.ts
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioDraftsPanel.tsx`.
...
## Expected Result
- StudioDraftsPanel compiles without useParams and passes its focused test.
