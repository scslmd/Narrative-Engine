# Executor Prompt: RH-T033 - Integrate layout preset UI into StudioCommandBar
...
- Serial dependencies: RH-T011, RH-T032
- Same-file serial group: studio-command-bar

## Objective
Mount the layout preset control next to the panel menu without changing existing toggle semantics.
