# Executor Prompt: RH-T032A - Add StudioLayoutPreset tests
...
- Responsible file: `frontend/src/components/studio/StudioLayoutPreset.test.tsx`
- Serial dependencies: RH-T032
- Same-file serial group: none

## Objective
Add focused tests for preset selection and import/export control rendering.
...
## Task Guardrails
- frontend/src/components/studio/StudioLayoutPreset.tsx
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioLayoutPreset.test.tsx`.
...
## Expected Result
- Focused StudioLayoutPreset tests pass.
