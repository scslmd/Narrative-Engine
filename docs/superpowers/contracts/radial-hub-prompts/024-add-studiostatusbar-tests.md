# Executor Prompt: RH-T024 - Add StudioStatusBar tests
...
- Responsible file: `frontend/src/components/studio/StudioStatusBar.test.tsx`
- Serial dependencies: RH-T023
- Same-file serial group: none

## Objective
Add focused coverage for status bar rendering and panel count text.
...
## Task Guardrails
- frontend/src/components/studio/StudioStatusBar.tsx
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioStatusBar.test.tsx`.
...
## Expected Result
- Focused StudioStatusBar tests pass.
