# Executor Prompt: RH-T047 - Apply final responsive and accessibility behavior to StudioPanelMenu
...
- Serial dependencies: RH-T005, RH-T044
- Same-file serial group: studio-panel-menu

## Objective
Add aria-haspopup/menu semantics and a fixed-position mobile bottom-sheet variant below xl.
