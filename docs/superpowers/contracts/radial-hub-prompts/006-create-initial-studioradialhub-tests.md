# Executor Prompt: RH-T006 - Create initial StudioRadialHub tests
...
- Responsible file: `frontend/src/components/studio/StudioRadialHub.test.tsx`
- Serial dependencies: RH-T001
- Same-file serial group: studio-radial-hub-tests

## Objective
Add the first rendering and data-radial-hub coverage tests for the layout manager.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioRadialHub.test.tsx`.
...
## Expected Result
- The test file exists and targets the Phase 1 radial-hub API.
