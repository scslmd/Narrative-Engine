# Executor Prompt: RH-T022 - Add layout presets to studioStore
...
## Objective
Add preset definitions and applyPreset support without changing existing panel actions.
...
## Expected Result
- Typecheck exits 0.
- applyPreset creates deterministic panel sets per preset name.
