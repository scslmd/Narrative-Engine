# Executor Prompt: RH-T014 - Update StudioContextPanel drafts call site
...
- Serial dependencies: RH-T013
- Same-file serial group: none

## Objective
Pass projectId into the drafts panel call site as transitional legacy support while StudioContextPanel still exists; leave manuscripts wiring unchanged and do not remove the legacy panel in this stage.
...
- `case 'drafts'`
- `StudioDraftsPanel projectId={projectId}`
- `case 'manuscripts'`
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioContextPanel.tsx`.
