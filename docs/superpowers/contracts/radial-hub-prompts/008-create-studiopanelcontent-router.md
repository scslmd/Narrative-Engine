# Executor Prompt: RH-T008 - Create StudioPanelContent router
...
## Objective
Create the panel-key switch component that maps known panel keys to existing panel components and falls back only for not-yet-wired keys.
...
## Task Guardrails
- frontend/src/components/studio/StudioDraftsPanel.tsx
...
## Expected Result
- Typecheck exits 0.
- The router covers all Phase 1 known panel keys without as any casts.
