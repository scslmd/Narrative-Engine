# Executor Prompt: RH-T040 - Update WorkspaceShell navigation to studio query URLs
...
- Same-file serial group: workspace-shell

## Objective
Change workspace navigation to go directly to studio or studio?tab=... without using old route segments.
...
## Instructions
1. Modify only `frontend/src/components/WorkspaceShell.tsx`.
