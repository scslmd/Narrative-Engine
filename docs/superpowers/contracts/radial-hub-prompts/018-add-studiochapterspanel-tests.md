# Executor Prompt: RH-T018 - Add StudioChaptersPanel tests
...
- Responsible file: `frontend/src/components/studio/StudioChaptersPanel.test.tsx`
- Serial dependencies: RH-T017
- Same-file serial group: none

## Objective
Add focused coverage for chapter list rendering and empty-state behavior.
...
## Task Guardrails
- frontend/src/components/studio/StudioChaptersPanel.tsx
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioChaptersPanel.test.tsx`.
...
## Expected Result
- Focused StudioChaptersPanel tests pass.
