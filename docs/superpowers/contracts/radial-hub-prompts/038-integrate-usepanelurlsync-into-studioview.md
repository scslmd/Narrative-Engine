# Executor Prompt: RH-T038 - Integrate usePanelUrlSync into StudioView
...
- Serial dependencies: RH-T025, RH-T037
- Same-file serial group: studio-view

## Objective
Add URL-sync initialization to StudioView using projectId ?? null and UI jobId wiring.
