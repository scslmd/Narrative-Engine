# Executor Prompt: RH-T034A - Add StudioFloatingPanel Phase 3 polish tests
...
- Responsible file: `frontend/src/components/studio/StudioFloatingPanel.phase3.test.tsx`
- Serial dependencies: RH-T034
- Same-file serial group: none

## Objective
Add focused tests for hover-preview wiring, resize throttling guardrails, and Phase 3 interaction behavior.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioFloatingPanel.phase3.test.tsx`.
...
## Expected Result
- Focused StudioFloatingPanel Phase 3 tests pass.
