# Executor Prompt: RH-T023 - Create StudioStatusBar implementation
...
- Serial dependencies: RH-T022
- Same-file serial group: studio-status-bar

## Objective
Create the bottom status bar with project info, panel count, collapse control, and preset badge.
