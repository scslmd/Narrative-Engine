# Executor Prompt: RH-T005 - Create StudioPanelMenu implementation
...
- Responsible file: `frontend/src/components/studio/StudioPanelMenu.tsx`
- Serial dependencies: RH-T001, RH-T004
- Same-file serial group: studio-panel-menu

## Objective
Implement the dropdown menu that adds visible panel instances and reflects active items.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioPanelMenu.tsx`.
...
## Expected Result
- Focused StudioPanelMenu tests pass.
- PANEL_OPTIONS includes drafts and manuscripts as well as structure, chapters, canon.
