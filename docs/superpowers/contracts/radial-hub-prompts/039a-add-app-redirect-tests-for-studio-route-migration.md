# Executor Prompt: RH-T039A - Add App redirect tests for studio route migration
...
- Responsible file: `frontend/src/App.redirects.test.tsx`
- Serial dependencies: RH-T039
- Same-file serial group: none

## Objective
Add focused route tests covering legacy workspace redirects to studio query-param URLs for plan, review, inspect, braindump, canon, generate, and write routes.
...
## Instructions
1. Modify only `frontend/src/App.redirects.test.tsx`.
