# Executor Prompt: RH-T025 - Add StudioStatusBar to StudioView
...
- Serial dependencies: RH-T009, RH-T023
- Same-file serial group: studio-view

## Objective
Mount StudioStatusBar below the WritingView and radial-hub stack.
