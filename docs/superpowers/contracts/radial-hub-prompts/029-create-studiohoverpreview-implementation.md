# Executor Prompt: RH-T029 - Create StudioHoverPreview implementation
...
- Responsible file: `frontend/src/components/studio/StudioHoverPreview.tsx`
- Serial dependencies: RH-T021
- Same-file serial group: none

## Objective
Create the delayed preview overlay using existing characters, worldBible, and brainstorm service functions only.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioHoverPreview.tsx`.
