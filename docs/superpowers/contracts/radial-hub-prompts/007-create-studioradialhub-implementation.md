# Executor Prompt: RH-T007 - Create StudioRadialHub implementation
...
- Responsible file: `frontend/src/components/studio/StudioRadialHub.tsx`
- Serial dependencies: RH-T001, RH-T003, RH-T006
- Same-file serial group: studio-radial-hub

## Objective
Implement the DndContext-based hub that loads layout, renders the grid backdrop, and mounts visible non-floating panels.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioRadialHub.tsx`.
...
## Expected Result
- Focused StudioRadialHub tests pass.
- Visible non-floating panels render through StudioFloatingPanel.
