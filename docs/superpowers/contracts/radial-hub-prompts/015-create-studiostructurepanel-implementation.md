# Executor Prompt: RH-T015 - Create StudioStructurePanel implementation
...
- Responsible file: `frontend/src/components/studio/StudioStructurePanel.tsx`
- Serial dependencies: RH-T009
- Same-file serial group: new-panel-components

## Objective
Implement the structure panel backed by getSequencePlans and getBeatPlans with loading, error, and empty states.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioStructurePanel.tsx`.
...
## Expected Result
- Typecheck exits 0.
- The panel uses only existing planning services.
