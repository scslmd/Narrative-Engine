# Executor Prompt: RH-T021 - Wire Structure, Chapters, Canon, and Drafts through StudioPanelContent
...
- Responsible file: `frontend/src/components/studio/StudioPanelContent.tsx`
- Serial dependencies: RH-T008, RH-T013, RH-T015, RH-T017, RH-T019
- Same-file serial group: studio-panel-content

## Objective
Extend the panel router so all known radial-hub panel keys resolve to concrete components instead of placeholder fallback.
...
## Task Guardrails
- frontend/src/components/studio/StudioManuscriptsPanel.tsx
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioPanelContent.tsx`.
...
## Expected Result
- No known radial-hub panel key falls through to the default placeholder.
