# Executor Prompt: RH-T020 - Add StudioCanonPanel tests
...
- Responsible file: `frontend/src/components/studio/StudioCanonPanel.test.tsx`
- Serial dependencies: RH-T019
- Same-file serial group: none

## Objective
Add focused coverage for canon profiles, annotations, and empty-state behavior.
...
## Task Guardrails
- frontend/src/components/studio/StudioCanonPanel.tsx
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioCanonPanel.test.tsx`.
...
## Expected Result
- Focused StudioCanonPanel tests pass.
