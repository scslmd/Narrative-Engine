# Executor Prompt: RH-T030 - Create usePanelKeyboard hook
...
- Responsible file: `frontend/src/hooks/usePanelKeyboard.ts`
- Serial dependencies: RH-T001
- Same-file serial group: none

## Objective
Create the panel keyboard hook with Ctrl+Shift+1-9, Ctrl+Shift+W, Ctrl+Alt+W, and Escape semantics.
...
## Instructions
1. Modify only `frontend/src/hooks/usePanelKeyboard.ts`.
