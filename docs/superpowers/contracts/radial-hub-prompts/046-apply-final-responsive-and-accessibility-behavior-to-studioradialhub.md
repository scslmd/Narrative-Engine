# Executor Prompt: RH-T046 - Apply final responsive and accessibility behavior to StudioRadialHub
...
- Serial dependencies: RH-T035, RH-T044, RH-T045
- Same-file serial group: studio-radial-hub

## Objective
Add role=main, aria-label, mobile stack mode via useMediaQuery, and keep desktop floating behavior for xl and above.
