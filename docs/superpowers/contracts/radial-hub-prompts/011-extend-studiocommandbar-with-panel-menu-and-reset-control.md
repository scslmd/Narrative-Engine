# Executor Prompt: RH-T011 - Extend StudioCommandBar with panel menu and reset control
...
- Serial dependencies: RH-T005, RH-T009
- Same-file serial group: studio-command-bar

## Objective
Add projectId and onResetLayout props, keep existing rail and panel toggles, and append reset plus panel menu controls.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioCommandBar.tsx`.
