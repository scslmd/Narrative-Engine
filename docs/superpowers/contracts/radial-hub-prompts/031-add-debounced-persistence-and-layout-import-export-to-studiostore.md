# Executor Prompt: RH-T031 - Add debounced persistence and layout import/export to studioStore
...
## Objective
Add debounced v2 persistence, flush helper, layout preset application, exportLayout, and importLayout.
