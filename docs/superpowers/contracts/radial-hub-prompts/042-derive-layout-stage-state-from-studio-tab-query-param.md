# Executor Prompt: RH-T042 - Derive Layout stage state from studio tab query param
...
- Responsible file: `frontend/src/components/Layout.tsx`
- Serial dependencies: RH-T039, RH-T041
- Same-file serial group: none

## Objective
Update stage derivation and stage-button navigation so the stage bar reflects the active studio tab.
...
## Instructions
1. Modify only `frontend/src/components/Layout.tsx`.
