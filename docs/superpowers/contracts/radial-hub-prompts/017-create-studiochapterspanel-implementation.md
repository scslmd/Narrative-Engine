# Executor Prompt: RH-T017 - Create StudioChaptersPanel implementation
...
- Responsible file: `frontend/src/components/studio/StudioChaptersPanel.tsx`
- Serial dependencies: RH-T009
- Same-file serial group: new-panel-components

## Objective
Implement the chapters panel using getChapterPlans and getChapterPackets with deterministic list rendering and empty states.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioChaptersPanel.tsx`.
