# Executor Prompt: RH-T030A - Add usePanelKeyboard tests
...
- Responsible file: `frontend/src/hooks/usePanelKeyboard.test.ts`
- Serial dependencies: RH-T030
- Same-file serial group: none

## Objective
Add focused tests for Ctrl+Shift panel shortcuts, Ctrl+Shift+W close, Ctrl+Alt+W reattach, and Escape semantics.
...
## Instructions
1. Modify only `frontend/src/hooks/usePanelKeyboard.test.ts`.
...
## Expected Result
- Focused usePanelKeyboard tests pass.
