# Executor Prompt: RH-T031A - Add studioStore layout persistence tests
...
- Responsible file: `frontend/src/stores/studioStore.layoutPersistence.test.ts`
- Serial dependencies: RH-T031
- Same-file serial group: none

## Objective
Add focused tests for debounced persistence, preset application, and deterministic layout import/export behavior.
...
## Instructions
1. Modify only `frontend/src/stores/studioStore.layoutPersistence.test.ts`.
...
## Expected Result
- Focused studioStore layout persistence tests pass.
