# Executor Prompt: RH-T019 - Create StudioCanonPanel implementation
...
- Responsible file: `frontend/src/components/studio/StudioCanonPanel.tsx`
- Serial dependencies: RH-T009
- Same-file serial group: new-panel-components

## Objective
Implement the canon panel using getCanonProfiles and getCanonAnnotations with real annotation kinds, tabs, and empty states.
...
## Task Guardrails
- frontend/src/services/canon.ts
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioCanonPanel.tsx`.
