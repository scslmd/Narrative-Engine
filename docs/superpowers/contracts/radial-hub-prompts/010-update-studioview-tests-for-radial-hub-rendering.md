# Executor Prompt: RH-T010 - Update StudioView tests for radial hub rendering
...
- Same-file serial group: studio-view-tests

## Objective
Update StudioView tests to assert radial-hub rendering on the studio route.
...
## Instructions
1. Modify only `frontend/src/views/StudioView.test.tsx`.
