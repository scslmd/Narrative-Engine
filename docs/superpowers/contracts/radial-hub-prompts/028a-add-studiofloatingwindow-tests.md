# Executor Prompt: RH-T028A - Add StudioFloatingWindow tests
...
- Responsible file: `frontend/src/components/studio/StudioFloatingWindow.test.tsx`
- Serial dependencies: RH-T028
- Same-file serial group: none

## Objective
Add focused tests covering portal render, reattach control exposure, and floating-window container rendering.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioFloatingWindow.test.tsx`.
...
## Expected Result
- Focused StudioFloatingWindow tests pass.
