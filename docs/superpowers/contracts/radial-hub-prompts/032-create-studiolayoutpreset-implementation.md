# Executor Prompt: RH-T032 - Create StudioLayoutPreset implementation
...
- Responsible file: `frontend/src/components/studio/StudioLayoutPreset.tsx`
- Serial dependencies: RH-T031
- Same-file serial group: none

## Objective
Create the layout preset menu with preset application and JSON import/export UI and no projectId prop.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioLayoutPreset.tsx`.
