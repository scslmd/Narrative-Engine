# Executor Prompt: RH-T012 - Add StudioDraftsPanel prop-based test coverage
...
- Responsible file: `frontend/src/components/studio/StudioDraftsPanel.test.tsx`
- Serial dependencies: RH-T009
- Same-file serial group: none

## Objective
Create a focused test proving StudioDraftsPanel renders when projectId is passed as a prop.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioDraftsPanel.test.tsx`.
...
## Expected Result
- The focused test targets prop-based rendering instead of useParams.
