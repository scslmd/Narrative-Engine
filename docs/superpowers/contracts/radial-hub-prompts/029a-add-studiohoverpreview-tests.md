# Executor Prompt: RH-T029A - Add StudioHoverPreview tests
...
- Responsible file: `frontend/src/components/studio/StudioHoverPreview.test.tsx`
- Serial dependencies: RH-T029
- Same-file serial group: none

## Objective
Add focused tests for delayed preview rendering, loading state, and empty-state fallback.
...
## Task Guardrails
- frontend/src/components/studio/StudioHoverPreview.tsx
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioHoverPreview.test.tsx`.
...
## Expected Result
- Focused StudioHoverPreview tests pass.
