# Executor Prompt: RH-T035A - Add StudioRadialHub Phase 3 polish tests
...
- Responsible file: `frontend/src/components/studio/StudioRadialHub.phase3.test.tsx`
- Serial dependencies: RH-T035
- Same-file serial group: none

## Objective
Add focused tests for snap-indicator rendering, floating-window rendering, drag-start bring-to-front, and viewport clamping behavior.
...
## Instructions
1. Modify only `frontend/src/components/studio/StudioRadialHub.phase3.test.tsx`.
...
## Expected Result
- Focused StudioRadialHub Phase 3 tests pass.
