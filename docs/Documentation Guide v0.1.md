...
- `README.md`: high-level product overview, quickstart, and current entry links
- `AGENTS.md`: current repo-specific engineering rules and validation expectations
- `BACKEND_API_REFERENCE.md`: current API route reference with mixed versioning notes
- `STRUCTURE.md`: practical repository map describing the purpose of the main folders and key files
- `docs/Narrative SRS v0.3.md`: backend and product specification baseline for the current system
- `TODO.md`: the live implementation plan and the best place to confirm which backend slices are already accepted versus still planned
- `docs/Frontend Design SRS v0.5.md`: frontend workflow and interaction baseline
...
- `docs/Project Index v0.1.md`: high-level status snapshot of implemented foundations and major remaining work
- `docs/Validation Notes v0.1.md`: latest verified validation command set and known coverage boundaries
- `docs/QUALITY_GUIDELINES.md`: reusable quality rubric for code and doc changes
...
Historical notes, superseded readiness checklists, review dumps, and temporary task exports live under `docs/archive/`.
