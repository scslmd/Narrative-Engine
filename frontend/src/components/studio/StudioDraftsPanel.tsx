      ...
      <div className="flex-1 overflow-y-auto p-2.5 space-y-2">
        {draftsQueryLoading ? (
          ...
          <div className="text-center py-6">
            <p className="text-xs text-gray-500 dark:text-slate-400 mb-2">No drafts yet</p>
            <div className="flex justify-center gap-1.5">
              <button
                onClick={handleCreateDraft}
                className={`flex items-center gap-1 text-[10px] px-2 py-1 rounded border transition-colors ${isDark ? 'border-slate-700 text-slate-300 hover:border-slate-600 hover:bg-slate-800' : 'border-slate-300 text-slate-600 hover:border-slate-400 hover:bg-slate-50'}`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-1 text-[10px] px-2 py-1 rounded border transition-colors ${isDark ? 'border-amber-800 text-amber-400 hover:border-amber-700 hover:bg-slate-800' : 'border-amber-300 text-amber-600 hover:border-amber-400 hover:bg-amber-50'}`}
              >
