  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="text-center py-4">
             <p className="text-[10px] text-gray-500 dark:text-slate-400 mb-1">No drafts yet</p>
            <div className="flex justify-center gap-1">
               <button
                 onClick={handleCreateDraft}
                 className={`flex items-center gap-1 text-[9px] px-1.5 py-0.5 rounded border transition-colors ${isDark ? 'border-slate-700 text-slate-300 hover:border-slate-600 hover:bg-slate-800' : 'border-slate-300 text-slate-600 hover:border-slate-400 hover:bg-slate-50'}`}
               >
               ...
               <button
                 ...
                 className={`flex items-center gap-1 text-[9px] px-1.5 py-0.5 rounded border transition-colors ${isDark ? 'border-amber-800 text-amber-400 hover:border-amber-700 hover:bg-slate-800' : 'border-amber-300 text-amber-600 hover:border-amber-400 hover:bg-amber-50'}`}
               >
